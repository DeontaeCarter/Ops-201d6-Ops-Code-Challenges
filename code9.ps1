...
Get-EventLog -LogName System -After (Get-Date).AddDays(2/15/23) | Format-Table -AutoSize | Out-File c:\Users\deontae\desktop\last_24.txt}

# Output all “error” type events from the System event log to a file on your desktop named errors.txt.

 Get-EventLog -LogName System -EntryType Error | Format-Table -AutoSize | Out-File c:\Users\deontae\desktop\errors.txt
